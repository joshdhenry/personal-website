/**
 * Typed content for the About section. Copy is verbatim per
 * designs/joshhenry.info.dc.html's #about section, per designs/CLAUDE.md's
 * "Copy rules" ("do not rewrite copy Josh supplied"). Do not edit without
 * updating that source spec first.
 */

export const aboutHeading = "About";

export const aboutProfessionalParagraph =
...
export const aboutPersonalParagraph =
...
export const aboutPortraitAlt = "Josh Henry";

// Metro asset require, not a JS module import.
export const aboutPortraitSource = require("../../assets/images/headshot.png");
